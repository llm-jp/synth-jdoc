...
deepspeed --num_gpus 8 src/train/jssoda/train_internvl3_5_jssoda.py \
    --model_name OpenGVLab/InternVL3_5-8B-HF \
    --revision 741a7d03020411e666c6109218ab71e08151ef86 \
    --output_dir /groups/gcg51557/experiments/0302_synth_html/checkpoints/InternVL3_5-8B-HF-JSSODa-train \
